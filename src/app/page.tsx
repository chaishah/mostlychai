...
export default async function Home() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      {/* About */}
      <section className="mb-20 pb-16 border-b border-cream-200">
        <p className="text-xs text-spice tracking-widest uppercase mb-5 font-sans">about</p>
      ...
      <section>
        <div className="flex items-center gap-4 mb-2">
          <p className="text-xs text-spice tracking-widest uppercase shrink-0">writing</p>
